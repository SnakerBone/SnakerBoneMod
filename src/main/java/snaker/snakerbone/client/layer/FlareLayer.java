...
public class FlareLayer extends GeoLayerRenderer<Flare> {
    ...
    public void render(PoseStack ps, MultiBufferSource mbs, int light, Flare entity, float swing, float amount, float pt, float age, float yaw, float pitch) {
        ...
        getRenderer().render(getEntityModel().getModel(new SnakerBoneResourceLocation("geo/flare.geo.json")), entity, pt, SnakerBoneShaders.EFIRE, ps, mbs, null, light, LivingEntityRenderer.getOverlayCoords(entity, 0), 1, 1, 1, 1);
