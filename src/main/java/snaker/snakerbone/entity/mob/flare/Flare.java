package snaker.snakerbone.entity.mob.flare;
...
public class Flare extends MobBase implements IAnimatable {
    ...
    public static AttributeSupplier attributes() {
        return Monster.createMobAttributes()
                .add(Attributes.MAX_HEALTH, SnakerBoneAttributes.FLARE_HEALTH)
                .add(Attributes.ATTACK_DAMAGE, SnakerBoneAttributes.FLARE_ATTACK)
