package snaker.snakerbone.entity.mob.cosmo;
...
public class Cosmo extends MobBase implements IAnimatable {
    ...
    public static AttributeSupplier attributes() {
        return Monster.createMobAttributes()
                .add(Attributes.MAX_HEALTH, SnakerBoneAttributes.COSMO_HEALTH)
                .add(Attributes.ATTACK_DAMAGE, SnakerBoneAttributes.COSMO_ATTACK)
                .add(Attributes.FOLLOW_RANGE, SnakerBoneAttributes.FOLLOW_RANGE)
                .add(Attributes.ATTACK_SPEED, SnakerBoneAttributes.ATTACK_SPEED)
                .add(Attributes.MOVEMENT_SPEED, SnakerBoneAttributes.MOVEMENT_SPEED).build();
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor accessor, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData group, @Nullable CompoundTag tag) {
        ...
        SnakerBoneEntityVariants.Cosmo variant = Util.getRandom(SnakerBoneEntityVariants.Cosmo.values(), random);

        SnakerBoneEntityVariants.Cosmo end = SnakerBoneEntityVariants.Cosmo.PURPLE;
        SnakerBoneEntityVariants.Cosmo nether = SnakerBoneEntityVariants.Cosmo.RED;
        SnakerBoneEntityVariants.Cosmo alpha = SnakerBoneEntityVariants.Cosmo.ALPHA;
    ...
    public SnakerBoneEntityVariants.Cosmo getVariant() {

        return SnakerBoneEntityVariants.Cosmo.byId(this.getTypeVariant() & 255);
    ...
    private void setVariant(SnakerBoneEntityVariants.Cosmo variant) {
    ...
    protected SoundEvent getHurtSound(DamageSource source) {
        ...
        return SnakerBoneContentRegistry.COSMO_HURT.get();
